...
switch off. See [Chapter 14](chapter-14-the-mailbox.md).
...
[Chapter 9](chapter-09-exams-and-assessment.md).
...
See [Chapter 15](chapter-15-plans-and-access.md).
...
open. On a phone, every label shows. See [Chapter 17](chapter-17-appearance-and-navigation.md).
