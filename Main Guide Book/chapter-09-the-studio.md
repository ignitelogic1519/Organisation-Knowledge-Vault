...
![The Document Studio, editing a live document](images/studio.png)
...
![The Studio's front door — document, exam, or a draft to continue](images/studio-choose.png)
...
- **Members with the content grant submit for review** — the document becomes a proposal an
  ...
  ([Chapter 7](chapter-07-people-and-governance.md) grants the right;
  [Chapter 11](chapter-11-editions-and-review.md) is the channel it travels through).
...
![Revising a live document — the deployment banner, and the next edition's number](images/studio-revise.png)
...
[Chapter 11](chapter-11-editions-and-review.md) covers the whole editions story — the edition
...
**Next:** [Chapter 10 — Exams & assessment →](chapter-10-exams-and-assessment.md)
